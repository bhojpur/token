...
func (LogSliceType) Descriptor() protoreflect.EnumDescriptor {
	return file_token_proto_enumTypes[4].Descriptor()
}

func (LogSliceType) Type() protoreflect.EnumType {
	return &file_token_proto_enumTypes[4]
}
...
func (x *StopEngineRequest) Reset() {
	*x = StopEngineRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_token_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StopEngineRequest) Descriptor() ([]byte, []int) {
	return file_token_proto_rawDescGZIP(), []int{22}
}
...
func (x *StopEngineResponse) Reset() {
	*x = StopEngineResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_token_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StopEngineResponse) Descriptor() ([]byte, []int) {
	return file_token_proto_rawDescGZIP(), []int{23}
}
...
var file_token_proto_rawDesc = []byte{
	...
	0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x06, 0x32, 0xa8, 0x04, 0x0a, 0x0c, 0x54, 0x6f, 0x6b, 0x65,
	...
	0x2f, 0x62, 0x68, 0x6f, 0x6a, 0x70, 0x75, 0x72, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2f, 0x70,
...
var file_token_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_token_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
...
var file_token_proto_depIdxs = []int32{
	...
	5,  // 27: v1.TokenService.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.TokenService.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.TokenService.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.TokenService.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.TokenService.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.TokenService.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.TokenService.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.TokenService.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.TokenService.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.TokenService.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.TokenService.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.TokenService.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.TokenService.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.TokenService.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.TokenService.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.TokenService.StopEngine:output_type -> v1.StopEngineResponse
...
func file_token_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_token_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_token_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
	...
	file_token_proto_msgTypes[14].OneofWrappers = []interface{}{
